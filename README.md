...
# Or download a specific version (replace TAG with the version tag):
# curl -LO https://github.com/BD7PIL/octg-legacy-glibc/releases/download/TAG/octg-legacy-glibc-TAG.tar.gz
